...
<template>
  <main class="container max-w-5xl mx-auto p-4 pb-8">
    ...
    <input type="text" v-model="searchInput" placeholder="Search games..." class="input input-bordered mb-4 w-full max-w-md" />
    ...
    <div class="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-5" v-if="!isLoading && products.length">
